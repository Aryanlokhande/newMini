...
// for(let i=0;i<14;i++){
//     query=`
//     select f_assignment_id from assignment_allocation where class_id=(
//     select class_id from assignment_system_student where student_id="${i<=8?`0${i+1}`:`${i+1}`}")
//     `
//     con.query(query,(error,result)=>{
//         if(error){
//             console.log(error)
...
// let query=`insert into feedback_questions values\n`
// for(let i=0;i<10;i++){
//     if(i===9){
//         query=query+`('question${i+1}','${questions[i]}');`
//     }
//     else{
//         query=query+`('question${i+1}','${questions[i]}'),\n`
//     }
