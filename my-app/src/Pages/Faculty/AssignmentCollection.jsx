                    ...
                    <div className="eachSub" key={ind}>
                        {
                            ...
                            <div key={ind} className="assignmentCard">
                                <div className="detail">
                                    ...
                                    <p>Scheduled Date: {a.scheduled_date}</p> 
                                    <p>Allocated Date: <input type="date" onChange={handleDateChange}/> </p>
                                    <p>{a.isLocked}</p>
                                </div>
                                ...
                                <div className="detail-options">
                                    <label onClick={()=>handleCheckId(a.f_assignment_id)} htmlFor={`${a.f_assignment_id}`}>
                                        Opt
                                    </label>
